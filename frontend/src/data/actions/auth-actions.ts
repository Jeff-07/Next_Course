...
//validates date from the signup form
...
//validates information in the signin form
...
export async function loginUserAction(prevState: any, formData: FormData) {
  ...
  //retrieves data from signin form
...
export async function logoutAction() {
  const cookieStore = await cookies();
  cookieStore.set("jwt", "", {...config, maxAge: 0}); //deletes information on cookies
  redirect("/");
}